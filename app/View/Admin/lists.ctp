<div class="row">
    <div class="col-md-12">
        <p>
            <a role="button" class="btn btn-primary" href="/admin/listsadd/<?=$name?>" title="Добавить">Добавить новую</a>
        </p>
        ...
        <table class="table table-bordered">                            
            ...
            <tbody>                               
                ...
                <tr>                     
                    ...
                    <?endif;?>
                    <td> 
                        <a role="button" class="btn btn-primary btn-xs" href="/admin/listsedit/<?=$name?>/<?=$value[$models['good']]['id']?>" title="Редактировать"><i class="glyphicon glyphicon-pencil"></i></a>
                        <a role="button" class="btn btn-primary btn-xs"  href="/admin/listsdelete/<?=$name?>/<?=$value[$models['good']]['id']?>" title="Удалить"><i class="glyphicon glyphicon-remove"></i></a
                    </td>                               
                </tr> 
                <?endforeach;?>
            </tbody>
