(function() {
    ...
    i.extend(h.bi.prototype, {
        ...
        vn: function(k) {
            var l = this,
                m = [];
            do m[k ? 'push' : 'unshift'](l); while (l = l.getParent()) return m;
        },
        vv: function(k) {
            var m = this;
                ...
                this.oW('jv', D, function jv(F, G) {
                    ...
                    try {
                        ...
                        if (B && H >= 37 && H <= 40) {
                            ...
                            if (!A.isRoot && A.parent) this.tools.cT(A.parent);
                        }
                ...
                E.on('uiReady', function tu(H) {
                    ...
                    E.bD('DownloadFile', {
                        exec: function(L) {
                            var M = J.data().cG;
                            if (M)
                                if (L.config.directDownload) window.location = M.folder.getUrl() + M.name + '?download';
    ...
    n.button.prototype = {
        ...
        er: function(p, q) {
            ...
            else q.push(' onkeydown="window.parent.CKFinder._.uiButtonKeydown(', v, ', event);" onfocus="window.parent.CKFinder._.uiButtonFocus(', v, ', event);" onclick="window.parent.CKFinder._.callFunction(', u, ', this); return false;">'); if (this.icon !== false) q.push('<span class="cke_icon"');
            if (this.icon) {
                var y = (this.rD || 0) * -16;
    ...
    (function() {
        ...
        function A(P) {
            ...
            function au(aP) {
                ...
                else pw = aa.eS; if (aa.fi - U[2] > gs.height - aT) aq = gs.height + U[2];
